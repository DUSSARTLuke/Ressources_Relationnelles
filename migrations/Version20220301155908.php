 ...
 */
final class Version20220301155908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, created_by INT NOT NULL, name VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, status ENUM(\'WA\', \'PU\', \'SU\', \'DE\') DEFAULT \'WA\' NOT NULL COMMENT \'(DC2Type:ResourceStatusType)\', resource_type ENUM(\'GA\', \'AR\', \'CH\', \'PC\', \'WO\', \'RS\', \'OG\', \'VI\') NOT NULL COMMENT \'(DC2Type:ResourceType)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BC91F41612469DE2 (category_id), INDEX IDX_BC91F416DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
