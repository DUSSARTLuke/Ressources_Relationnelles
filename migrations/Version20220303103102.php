 ...
 */
final class Version20220303103102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource ADD visibility ENUM(\'PUB\', \'PRI\', \'SH\') DEFAULT \'PUB\' NOT NULL COMMENT \'(DC2Type:ResourceVisibilityType)\', CHANGE status status ENUM(\'WA\', \'PU\', \'SU\', \'DE\') DEFAULT \'WA\' NOT NULL COMMENT \'(DC2Type:ResourceStatusType)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resource DROP visibility, CHANGE status status ENUM(\'WA\', \'PU\', \'SU\', \'DE\') DEFAULT \'WA\' CHARACTER SET utf8mb4 DEFAULT \'WA\' NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:ResourceStatusType)\'');
    }
}
